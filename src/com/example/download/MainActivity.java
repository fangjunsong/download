...
public class MainActivity extends ListActivity  {  
    ...
    // 固定下载的资源路径，这里可以设置网络上的地址  
     private static final String URL = " http://sc.111ttt.com/up/mp3/255629/22BFCD3468D358ADDD2AED73646D1DB9.mp3";  
     // 固定存放下载的音乐的路径：SD卡目录下  
     private static final String SD_PATH = "/mp3/";  
     // 存放各个下载器  
     ...
     private void showListView() {  
         ...
         map.put("name", "ou.mp3");  
         data.add(map);  
         SimpleAdapter adapter = new SimpleAdapter(this, data, R.layout.item_list, new String[] { "name" },  
